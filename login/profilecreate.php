...
<head>
  ...
  <style>
    ...
    .login-card-body .achievements input,
    .login-card-body .achievements textarea {
      width: 100%;
      padding: 5px 10px;
      border-radius: 4px;
      border: 1px solid #ccc;
    ...
    .login-card-body .moreachievementscls input,
    .login-card-body .moreachievementscls textarea {
      width: 100%;
      padding: 5px 10px;
      border-radius: 4px;
      border: 1px solid #ccc;
    ...
    .login-card-body .portfolio input,
    .login-card-body .portfolio textarea {
      width: 100%;
      padding: 5px 10px;
      border-radius: 4px;
      border: 1px solid #ccc;
    ...
    .loginbtnnn {
      ...
      display: block;
      /* Change display to block to center the button */
      margin: 0 auto;
...
<body class="hold-transition login-page">
        ...
        <form method="POST" action="afterprofileinsert.php" onsubmit="return validateForm();" enctype="multipart/form-data">
          ...
          <div class="portfolio">
            ...
            <div class="form-group">
              ...
              <input type="file" id="imageprofolio" name="imageprofolio" accept="image/*, video/*" />
            </div>
          ...
          <div class="projects" style="margin-left:25px;">
            ...
            <div class="form-group">
              ...
              <input type="text" id="link_1_1" name="link_1_1" placeholder="link_1" />
            </div>
            <div class="form-group">
              <label for="awardedby">Link2:</label>
              <input type="text" id="link_1_2" name="link_1_2" placeholder="link_2" />
            </div>
            <div class="form-group">
              <label for="description">Link3:</label>
              <input id="link_1_3" name="link_1_3" placeholder="link_3">
            </div>
            <div class="form-group">
              <label for="youtubeLink">Link4:</label>
              <input type="text" id="link_1_4" name="link_1_4" placeholder="link_4" />
            </div>
            <div class="form-group">
              <label for="youtubeLink">Link5:</label>
              <input type="text" id="link_1_5" name="link_1_5" placeholder="link_5" />
            </div>
            <!-- Add more portfolio inputs here as needed -->
          </div>
          ...
          <input type="hidden" id="projectsdyid" name="projectsdyid" value="1">
          <input type="hidden" id="achivementdyidd" name="achivementdyidd" value="1">
          <input type="hidden" id="users_id" name="users_id" value="<?php echo $_SESSION['users_id']; ?>">
          <input type="hidden" id="rolemasteridd" name="rolemasteridd" value="<?php echo $rolemaster_id; ?>">
        </form><br>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function addMoreAchievements(id) {
      ...
      id++;
      var inputbx = $("#achivementdyidd").val(id);
  ...
  <script>
    function addMoreprojects(id) {
      ...
      var inputbx = $("#projectsdyid").val(id);
      ...
      if (id <= 10) {
        var popupHtml = '<div class="projects" id="projectsidd' + id + '" style="margin-left:25px;">' +
          ...
          '<div class="form-group">' +
          '<label for="year">Link1:</label>' +
          '<input type="text" id="link_' + id + '_1" name="link_' + id + '_1" placeholder="link_1" />' +
          '</div>' +
          '<div class="form-group">' +
          '<label for="awardedby">Link2:</label>' +
          '<input type="text" id="link_' + id + '_2" name="link_' + id + '_2" placeholder="link_2" />' +
          '</div>' +
          '<div class="form-group">' +
          '<label for="description">Link3:</label>' +
          '<input id="link_' + id + '_3" name="link_' + id + '_3"  placeholder="link_3">' +
          '</div>' +

          '<div class="form-group">' +
          '<label for="youtubeLink">Link4:</label>' +
          '<input type="text" id="link_' + id + '_4" name="link_' + id + '_4" placeholder="link_4" />' +
          '</div>' +

          '<div class="form-group">' +
          '<label for="youtubeLink">Link5:</label>' +
          '<input type="text" id="link_' + id + '_5" name="link_' + id + '_5" placeholder="link_5" />' +
          '</div>' +
